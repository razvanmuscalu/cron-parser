...
class CronCommandSpec extends BaseSpec {
  ...
  "CronCommand" should {
    ...
    "return thrown error for day of month" in {
      val cronCommand = CronCommand("1", "2", "32", "4", "5", "/usr/bin/find")
      cronCommand.parsed shouldBe Left("Maximum value for day of month is 31")
    }
